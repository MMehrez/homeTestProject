...
def geocodingGoogle(requested_address,url):
...
# google geocoding function
def geocodingHere(requested_address,url):
...
if __name__ == '__main__':
    ...
    while i < len(requested_addresses):
        location = geocodingGoogle(requested_addresses[i],url_google) #primary geocoding service
        if location == 'Error':
            location = geocodingHere(requested_addresses[i],url_here) #Secondary geocoding service
